...
if args.eval_dataset == 'ShanghaiA':
    ...
    pred_file = '/home/wenzhe/bulk/Experiments/Crowd/FIDIM/FIDTM-master_ACM/local_eval/point_files/ShanghaiA_baseline_coat_dense_localization.txt'
    id_std = [i for i in range(1, 183, 1)]

elif args.eval_dataset == 'ShanghaiB':
    gt_file = './point_files/B_gt.txt'
    pred_file = '/home/wenzhe/bulk/Experiments/Crowd/FIDIM/FIDTM-master_ACM/local_eval/point_files/shanghaiB8.1_localization.txt'
    ...
    pred_file = '/home/xiangyu/code/C3/FIDTM-master/local_eval/point_files/nwpu_pred_fidt (val set).txt'
