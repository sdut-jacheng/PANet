...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default= '/home/xiangyu/code/C3/MANet/UCF-QNRF_ECCV18', type=str, help='the QNRF data path')
    ...
    for i in range(1, 101):
        ...
        pred_file = '/home/wenzhe/bulk/Experiments/Crowd/FIDIM/FIDTM-master_ACM/local_eval/point_files/qnrf1++_localization.txt'
